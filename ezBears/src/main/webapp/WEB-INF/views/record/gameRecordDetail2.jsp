	...
	<div role="tablist" class="subFilter__group">
		<a title="경기" aria-current="page" class="active"
			...
			title="1회" class="" href="#/match-summary/match-statistics/1"><button
				role="tab" class="subFilter__filter" id="tab-1">1회</button></a><a
			title="2" class="" href="#/match-summary/match-statistics/2"><button
				role="tab" class="subFilter__filter" id="tab-2">2</button></a><a
			title="3" class="" href="#/match-summary/match-statistics/3"><button
				role="tab" class="subFilter__filter" id="tab-3">3</button></a><a
			title="4" class="" href="#/match-summary/match-statistics/4"><button
				role="tab" class="subFilter__filter" id="tab-4">4</button></a><a
			title="5" class="" href="#/match-summary/match-statistics/5"><button
				role="tab" class="subFilter__filter" id="tab-5">5</button></a><a
			title="6" class="" href="#/match-summary/match-statistics/6"><button
				role="tab" class="subFilter__filter" id="tab-6">6</button></a><a
			title="7" class="" href="#/match-summary/match-statistics/7"><button
				role="tab" class="subFilter__filter" id="tab-7">7</button></a><a
			title="8" class="" href="#/match-summary/match-statistics/8"><button
				role="tab" class="subFilter__filter" id="tab-8">8</button></a><a
			title="9" class="" href="#/match-summary/match-statistics/9"><button
				role="tab" class="subFilter__filter" id="tab-9">9</button></a>
	</div>
		...
		tabButtons.forEach(function(button) {
			button.addEventListener('click', function() {
				...
				const selectedSection = document
						.querySelector('.section[data-title="' + targetTitle
								+ '"]');
				if (selectedSection) {
